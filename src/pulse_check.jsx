/* ============================================================
   Pulse Check — seller branding components
   ============================================================ */
...
const DemoBanner = ({ onSetUp, onDismiss }) => (
  <div className="demo-banner">
    <span className="pc-logo-text">
      <img src="assets/pulse-check-logo.png" alt="Pulse Check" style={{ height: 18, filter: 'brightness(0) invert(1)' }} />
    </span>
...
/* Pulse Check welcome / splash — shown on first launch */
    ...
    <div className="pc-splash-card">
      ...
      <div className="pc-splash-content">
        ...
        <div style={{ fontSize: 11.5, color: 'oklch(0.55 0.02 250)', marginTop: 4 }}>
          Need help? Email <strong style={{ color: 'var(--pc-navy)' }}>hello@pulsecheck.app</strong> — replies usually within a day.
        </div>
      </div>
    </div>
  </div>
        ...
        <div style={{ padding: '32px 36px 28px' }}>
          <div className="row between" style={{ marginBottom: 22 }}>
            <div className="row" style={{ gap: 12 }}>
              <img src="assets/pulse-check-logo.png" alt="Pulse Check" style={{ height: 22 }} />
...
const PoweredByPulseCheck = () => (
  <a href="#" onClick={(e) => e.preventDefault()} className="powered-by" title="Built by Pulse Check">
    Powered by
    <img src="assets/pulse-check-logo.png" alt="Pulse Check" />
  </a>
);
